...
buyConfirmDays  = 5;
sellConfirmDays = 8; % or 7 for a safe backup with slightly less drawdown
...
StrategysharpeApprox = sqrt(252) * mean(strategyReturnNet) / std(strategyReturnNet);
buyHoldSharpeApprox = sqrt(252) * mean(dailyReturn) / std(dailyReturn);
